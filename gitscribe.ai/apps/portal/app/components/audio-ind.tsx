...
import {
    ...
    getUniqueClipId,
    useAudioIndicator
} from './AudioIndicatorContext';

// Re-export the provider for convenience
export { AudioIndicatorProvider } from './AudioIndicatorContext';

export function AudioIndicator({ color = 'white' }: { color?: string }) {
    const { audioTrack } = useAudioIndicator();
